# 1 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\iManagerV1.ino"
# 2 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\iManagerV1.ino" 2
# 3 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\iManagerV1.ino" 2
# 4 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\iManagerV1.ino" 2
# 5 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\iManagerV1.ino" 2
...
void setup(void)
{
  ...
  {
    pinMode(valve_A[i], 0x1);
    pinMode(valve_B[i], 0x1);
  }
  menubutton_Init(28 /* | 28      |        |           |          | SPI2_SCK               |           |*/, 29 /* | 29      |        |           |          | SPI2_MISO              |           |*/, 27 /* | 27      |        |           |          | SPI2_SS                |           |*/, 8 /* | 8       |        |           | TWI3_SCL |                        |           |*/, 30 /* | 30      |        |           |          | SPI2_MOSI              |           |*/);
  pinMode(lcdBacklight, 0x1);
  pinMode(FS1, 0x2);
  pinMode(FS2, 0x2);
  pinMode(pumpPin, 0x1);
  //pinMode(PB11, OUTPUT);
 ...
 inputString.reserve(300);
  ...
  HardwareTimer *MyTim = new HardwareTimer(((TIM_TypeDef *) ((0x40000000UL /*!< Peripheral base address in the alias region                                */ + 0x00010000UL) + 0x0000UL)));
  MyTim->pause();
  MyTim->setOverflow(10000, HERTZ_FORMAT);
  MyTim->attachInterrupt(serialEvent1);
  MyTim->resume();
}
...
# 1 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\1_xml.ino"
/////////////////////////// selectBox  ////////////////////////////////////////////////////////////////
...
# 1 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\Battery.ino"
...
# 1 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\Home.ino"
void homepage()
{
  if (page == HOME)
  {
    ...
    do
    {
      ...
      if (simStatus == READY)
      {
        if (sigStrength < 10)
        {
          u8g2.drawXBMP(91, 1, 9, 5, icons8_network_1_bar);
        }
        else if (sigStrength >= 10 && sigStrength < 15)
        {
          u8g2.drawXBMP(91, 1, 9, 5, icons8_network_2_bar);
        }
        else if (sigStrength >= 15 && sigStrength < 20)
        {
          u8g2.drawXBMP(91, 1, 9, 5, icons8_network_3_bar);
        }
        else if (sigStrength >= 20 && sigStrength < 25)
        {
          u8g2.drawXBMP(91, 1, 9, 5, icons8_network_4_bar);
        }
        else if (sigStrength >= 25)
        {
          u8g2.drawXBMP(91, 1, 9, 5, icons8_network_5_bar);
        }
      }
      /***DISPLAY BATTERY ICON***/
      u8g2.drawXBMP(113 /*118*/, 0 /*1*/, /*9*/ 12 /*15*/, /*5*/ 7 /*9*/, icons8_empty_battery_32_2__bits);
      width = (percent * /*6*/ 9 /*11*/) / 100;
      u8g2.drawBox(/*119*/ 114, /*2*/ 1, width, /*3*/ 5 /*7*/);

      /***DISPLAY CALENDAR***/
      u8g2.setFont(u8g2_font_6x13B_tr); // u8g2_font_8x13B_tr
      u8g2.drawStr(0, 20 /*35*/, u8x8_u16toa(rtc.getHours(), 2));
      u8g2.drawStr(13, (20 /*35*/ - 1), ":");
      u8g2.drawStr(20, 20 /*35*/, u8x8_u16toa(rtc.getMinutes(), 2));
      u8g2.drawStr(33, (20 /*35*/ - 1), ":");
      u8g2.drawStr(40, 20 /*35*/, u8x8_u16toa(rtc.getSeconds(), 2));
      u8g2.drawStr(0, 32 /*47*/, u8x8_u16toa(rtc.getDay(), 2));
      u8g2.drawStr(14, 32 /*47*/, "/");
      u8g2.drawStr(20, 32 /*47*/, u8x8_u16toa(rtc.getMonth(), 2));
      u8g2.drawStr(34, 32 /*47*/, "/");
      u8g2.drawStr(40, 32 /*47*/, u8x8_u16toa(rtc.getYear() + 2000, 4));

      /***DISPLAY PUMP ICON***/
      // if (wOutlet == VALVE && digitalRead(pumpPin))
      // {
      u8g2.drawXBMP(24, (32 /*47*/ + 5), 14, 12, icons8_pump_16_bits);
      // }

      /***DISPLAY IRRIGATION ICON***/
      // else if (irr_valve == RUNNING || (wOutlet == PUMP && digitalRead(pumpPin)))
      // {
      u8g2.drawXBMP(0, (32 /*47*/ + 3), 14, 16, icons8_shower_24_20_1__bits);
      // }

      /***DISPLAY RUN CYCLE***/
      u8g2.drawXBMP(40, (32 /*47*/ + 5), 16, 16, icons8_bell_alarm);

      /***DISPLAY REST CYCLE***/
      u8g2.drawXBMP(55, (32 /*47*/ + 5), 16, 16, icons8_bell_snooze);

      /***DISPLAY RUN CYCLE***/
      u8g2.drawXBMP(75, (32 /*47*/ + 5), 16, 16, icons8_clock_snooze);

      /***DISPLAY REST CYCLE***/
      u8g2.drawXBMP(90, (32 /*47*/ + 5), 16, 16, icons8_clock_run);
      ...
      if (irr_mode == LOOP)
      {
        ...
        /***DISPLAY LOOP***/
        u8g2.drawXBMP(0, 0, 16, 8, icons8_loop);
        ...
        if (rSense == ON)
        {
          ...
          // display soil moisture
          u8g2.drawXBMP(86, 31, 12, 13, icons8_moisture_24_20_1__bits);
      ...
      {
        /***DISPLAY TIMER***/
        u8g2.drawXBMP(0, 0, 8, 8, icons8_clock);

        /***DISPLAY NEXT IRRIGATION TIME***/
        u8g2.setFont(u8g2_font_mozart_nbp_tr);
        if (next_prog < 13)
        {
          u8g2.drawStr(80, 20 /*35*/, u8x8_u16toa(Programs[next_prog - 1].StartHr, 2));
          u8g2.drawStr(94, (20 /*35*/ - 1), ":");
          u8g2.drawStr(100, 20 /*35*/, u8x8_u16toa(Programs[next_prog - 1].StartMin, 2));
          u8g2.drawStr(90, (32 /*47*/ - 4), dayShortStr(Programs[next_prog - 1].futureWkDay));
        }
        else if (next_prog == 13)
        {
          u8g2.drawStr(80, 20 /*35*/, u8x8_u16toa(Programs[clashProgs[0]].StartHr, 2));
          u8g2.drawStr(94, (20 /*35*/ - 1), ":");
          u8g2.drawStr(100, 20 /*35*/, u8x8_u16toa(Programs[clashProgs[0]].StartMin, 2));
          u8g2.drawStr(90, (32 /*47*/ - 4), dayShortStr(Programs[clashProgs[0]].futureWkDay));
        }

        /***DISPLAY BELL ICON***/
        u8g2.drawXBMP(115, (20 /*35*/ - 3), 8, 8, icons8_bell);
      ...
      {
        /***DISPLAY MANUAL***/
        u8g2.drawXBMP(0, 0, 8, 8, icons8_human);
        ...
        if (rSense == ON)
        {
          uint8_t soilmoisture = readSoilHumidity();
          // display soil moisture
          u8g2.drawXBMP(80, 20, 12, 13, icons8_moisture_24_20_1__bits);
          u8g2.setFont(u8g2_font_profont11_tr); // u8g2_font_ordinarybasis_tr
          // u8g2.setFontMode(1);
...
# 1 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\Irrigate.ino"
        ...
        { // if soil moisture sensor is connected
          ...
          { // if it has not rained
            ...
            irr_valve = RUNNING;
              ...
              if (valve == 0)
              { //valve 1
                digitalWrite(valve_1A, 0x1);
                digitalWrite(valve_1B, 0x0);
                delay(100);
                digitalWrite(valve_1A, 0x0);
                digitalWrite(valve_1B, 0x0);
                mtimerState[curr_prog - 1] = true;
                mtimerChrono[curr_prog - 1].restart();
              }
              ...
              { //valve 2
                digitalWrite(valve_2A, 0x1);
                digitalWrite(valve_2B, 0x0);
                delay(100);
                digitalWrite(valve_2A, 0x0);
                digitalWrite(valve_2B, 0x0);
                mtimerState[curr_prog - 1] = true;
                mtimerChrono[curr_prog - 1].restart();
              }
              ...
              { //valve 3
                digitalWrite(valve_3A, 0x1);
                digitalWrite(valve_3B, 0x0);
                delay(100);
                digitalWrite(valve_3A, 0x0);
                digitalWrite(valve_3B, 0x0);
                mtimerState[curr_prog - 1] = true;
                mtimerChrono[curr_prog - 1].restart();
              }
              ...
              { //valve 4
                digitalWrite(valve_4A, 0x1);
                digitalWrite(valve_4B, 0x0);
                delay(100);
                digitalWrite(valve_4A, 0x0);
                digitalWrite(valve_4B, 0x0);
                mtimerState[curr_prog - 1] = true;
                mtimerChrono[curr_prog - 1].restart();
              }
              ...
              { //all valves
                for (int i = 0; i < sizeof(valve_A); i++)
                {
                  digitalWrite(valve_A[i], 0x1);
                  digitalWrite(valve_B[i], 0x0);
                }
                delay(100); // clarify actual delay time
                for (int i = 0; i < sizeof(valve_A); i++)
                {
                  digitalWrite(valve_A[i], 0x0);
                  digitalWrite(valve_B[i], 0x0);
                }
                mtimerState[curr_prog - 1] = true;
                mtimerChrono[curr_prog - 1].restart();
...
# 283 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\Irrigate.ino"
...
//   }
// }
# 1 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\Menu.ino"
void menu_controls()
{
  /*
  ...
  */
# 6 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\Menu.ino"
  if (Debounce(&buttons[2]) == 0x1 && page == HOME)
    page = MENU;
  if (page == MENU)
  {
    // struct Timer * all;
  ...
  else if (page == TIMER)
  {
    ...
    case 7:
      ...
      /*
        ...
        */
# 188 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\Menu.ino"
...
# 1 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\Pumpwater.ino"
void pumpwater()
{
    if (wOutlet == VALVE)
    {
        if ((digitalRead(FS1) == 0x0 || digitalRead(FS2) == 0x0) && pumpState == PUMP_OFF)
        {
            pumpState = PUMP_ON;
        ...
        if (digitalRead(FS1) == 0x1 && digitalRead(FS2) == 0x1 && pumpState == PUMP_ON)
        {
            pumpState = PUMP_OFF;
...
# 1 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\Timer_analysis.ino"
//next_irr_flag = true
...
//      starthr_store[i] = 0;
//    }
# 1 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\cycle.ino"
void cycle_irrigate()
{
    if (irr_mode == LOOP)
    {
...
# 1 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\eeprom.ino"
void readEEPROM()
{
...
# 1 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\sms.ino"
void sms()
{
  ...
  if (simStatus == EROR)
  {
    ...
    {
      Serial1.println("AT+CFUN=0"); // turn on flight mode
      erorMills = millis();
      flag = true;
    }
    if (flag && millis() - erorMills >= 300)
    {
      Serial1.println("AT+CFUN=1"); // turn off flight mode
      erorMills = millis();
      flag = false;
    }
  }
    ...
    if (messageBody.startsWith("pwd"))
    {
      ...
      if (pass.length() == 4)
      {
        ...
        if (pass == password)
        {
          ...
          /*****MODE SELECTION*****/
          if (strstr(messageBody.c_str(), "mode") != 
# 148 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\sms.ino" 3 4
                                                    __null
# 148 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\sms.ino"
                                                        )
          {
           // ySerial.println("MODE FOUND");
            ...
            if (strstr(messageBody.c_str(), "cycle") != 
# 156 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\sms.ino" 3 4
                                                       __null
# 156 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\sms.ino"
                                                           )
            {
             // ySerial.println("CYCLE FOUND");
              irr_mode = LOOP;
              EEPROM.put(0 * sizeof(irr_mode), irr_mode);
              if (strstr(messageBody.c_str(), "run") != 
# 161 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\sms.ino" 3 4
                                                       __null
# 161 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\sms.ino"
                                                           )
              {
                //collect run time
              ...
              if (strstr(messageBody.c_str(), "rest") != 
# 171 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\sms.ino" 3 4
                                                        __null
# 171 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\sms.ino"
                                                            )
              {
                //collect rest time
  ...
  if(cycleFlag)
  {
    ...
    {
      Serial1.print("Cycle mode set to run for " + String(All_Str.cyc.Run) + " mins and rest for " + String(All_Str.cyc.Rest) + " mins."); //text content
      mMode = true;
      sMills = millis();
    }
...
void serialEvent1()
{
  ...
  {
    collectSmsData((char)Serial1.read()); // get the new byte:
...
# 1 "c:\\Users\\HP\\OneDrive\\arduino\\iManagerV1\\soil_moisture.ino"
uint8_t readSoilHumidity()
{
  ...
  mappedValue = ((mappedValue)<(0)?(0):((mappedValue)>(100)?(100):(mappedValue)));
