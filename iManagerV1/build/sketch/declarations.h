...
//Chrono timerChrono(Chrono::SECONDS);
...
static bool next_irr_flag, pump_init_flag, firstRun, stringComplete, messagestatus;
static const int PROG_SIZE = 12;
static int clashProgs[PROG_SIZE];
static String USER = "", PASS = "", inputString = "", homeScr = "", messageBody = "", password = "1234", phone = "+2348140699847", APN = "web.xxxx.mtnnigeria.net";
// static char *password = "1234";
// static char *phone = "+23481xxxxx847";
// static char *APN = "web.xxxx.mtnnigeria.net";
